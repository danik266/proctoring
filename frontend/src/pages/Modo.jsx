    ...
    <div className="fade-in">
      ...
      <div style={styles.bannerGreen}>
        ...
        <div style={{position: 'relative', zIndex: 1}}>
          <h2 style={styles.bannerTitle}>МОДО</h2>
          <p style={styles.bannerText}>Мониторинг Образовательных Достижений Обучающихся.</p>
        </div>
        <div style={styles.emoji}>📊</div>
      </div>

      <h3 style={styles.sectionTitle}>Тесты МОДО</h3>
          ...
          displayTests.map((test) => {
            ...
            return (
              <div key={test.id} style={styles.card}>
                ...
                >
                  {isFinished ? "Смотреть результат" : "Начать МОДО"}
                </button>
              </div>
            );
          })
